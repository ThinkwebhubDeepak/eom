            ...
            <div>
                <div class="position-sticky">
                    <div class="list-group list-group-flush mx-3 " style="margin-top: 30px;">
                        ...
                        <?php } ?>
                        <a href="attendance.php" class="list-group-item list-group-item-action py-2 ripple <?php echo ($page_name == 'my-efficiency' || $page_name == 'total-efficiency' || $page_name == 'today-efficiency') ? 'active' : '' ?>" data-bs-toggle="collapse" data-bs-target="#collapseEfficiency" aria-expanded="false" aria-controls="collapseEfficiency"><i class="fas fa-clock fa-fw me-1"></i><span>Efficiency</span></a>
                        <div class="collapse  <?php echo ($page_name == 'my-efficiency' || $page_name == 'today-efficiency' || $page_name == 'total-efficiency') ? 'show' : '' ?>" id="collapseEfficiency">
                            <div class="d-flex flex-column w-100 btn-group list-group collapse-btn">
