...
foreach ($projects as $project) {
  $optionProject .= '<option value="' . $project['id'] . '">' . $project['project_name'] . '</option>';
}
  ...
  <div class="container-flude pt-4">
    <div class="project_issue">
      <div class="projec-task">
            ...
            <form id="creatTaskForm">
              <div class="d-flex input-box">
                ...
                <select class="form-control" name="project_id" id="project_id" required>
                  ...
                  <?php
                  foreach ($projects as $project) {
                    $select = $task['project_id'] == $project['id'] ? 'selected' : '';
                    echo '<option value="' . $project['id'] . '" ' . $select . '>' . $project['project_name'] . '</option>';
                  }
                  ?>
                </select>
              </div>
              <div class="d-flex input-box">
                ...
                <div class="input-group">
                  <input type="text" name="task_id" value="<?php echo $task['task_id'] ?>" class="form-control" required readonly>
              ...
              <div class="d-flex input-box">
                ...
                <div class="input-group">
                  <input type="number" class="form-control overflow" value="<?php echo $task['estimated_hour'] ?>" name="estimated_hour" id="estimated_hour" required>
                </div>
              </div>
              <div class="d-flex input-box">
                <label for="Summary" class=" me-2 control-label">Area  <span style="color:red">*</span></label>
                <div class="input-group">
                  <input type="number" class="form-control overflow" value="<?php echo $task['area_sqkm'] ?>" name="area_sqkm" id="area_sqkm" required step="any">
                </div>
              </div>
              <hr class="bg-dark">
              ...
              <div class="d-flex input-box">
                ...
                <div class="input-group">
                  <input type="file" class="form-control Attachment-input overflow" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" name="attachment">
                </div>
              </div>
              <div class="d-flex input-box">
                <label for="firstName" class=" me-2 control-label" id="Complexity">Status </label>

                <input type="text" class="form-control" value="<?php echo $task['status'] ?>" name="status" readonly required>
              </div>
              <div>
                <div class="d-flex input-box no-margin">
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input type="text" class="datepicker form-control Attachment-input" id="datepicker" placeholder="Select a date" name="start_date" value="<?php echo $task['start_date'] ?>">
                  ...
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input type="text" class="datepicker form-control Attachment-input" id="datepicker1" placeholder="Select a date" name="end_date" value="<?php echo $task['end_date'] ?>">
                    </div>
                  </div>
                </div>
              </div>
        ...
        ?>
          <div>
            <p class="fw-bold page_heading">Create Task</p>
          </div>
          <!------ start modal ---------->
          <div class="first-modal">
            <a data-bs-toggle="modal" href="#myModal" class="btn btn-primary">CSV Upload <i class="fa-solid fa-arrow-up-from-bracket ms-2"></i></a>
                    ...
                    <div class="modal-body">
                      <div class="mb-3">
                        <div class="mb-3">
                          ...
                          <select class="form-select form-select" aria-label=".form-select-sm example" name="project_id" id="project_id" required>
                        ...
                        <div class="input-group">
                          <input type="file" class="form-control Attachment-input" id="Attachment_file" aria-describedby="inputGroupFileAddon04" aria-label="Upload" name="csvFile" required>
                        </div>
        ...
        <div class="project_form">
          ...
          <form id="creatTaskForm">
            ...
            <div class="d-flex input-box">
              <label for="Summary" class=" me-2 control-label">Original Estimated<span style="color:red">*</span></label>
              <div class="input-group">
            ...
            <div class="d-flex input-box">
              <label for="Summary" class=" me-2 control-label">Area <span style="color:red">*</span></label>
              <div class="input-group">
                <input type="number" class="form-control overflow" name="area_sqkm" required step="any">
              </div>
            </div>
            <hr class="bg-dark">
            <div class="d-flex input-box">
            ...
            <div>
              <div class="d-flex input-box no-margin">
                <div class="col-6">
                  <div class="input-box">
                    <label for="" class="me-3">Start date </label>
                    <input type="text" class="datepicker form-control Attachment-input" id="datepicker" placeholder="Select a date" name="start_date">
                  </div>
                </div>
                <div class="col-6">
                  <div class="input-box">
                    <label for="" class="me-3">End date</label>
                    <input type="text" class="datepicker form-control Attachment-input" id="datepicker1" placeholder="Select a date" name="end_date">
                  </div>
                </div>
              </div>
            </div>
...
<script>
  ...
  $('#uploadCsv').submit(function(event) {
    ...
    var formData = new FormData(this);
    $.ajax({
      url: 'includes/settings/api/csvTaskApi.php',
      type: 'POST',
      data: formData,
      cache: false,
      contentType: false,
