...
$tasks = $QcSQL->fetchAll(PDO::FETCH_ASSOC);
$countQc = count($tasks);
            ...
            <div class="row form-row mb-3">
              <div class="col-12 col-sm-6 p-2">
                <div class="form-group">
                  ...
                  <input type="hidden" name="type" value="addQcBreak" required>
        ...
        <div class="row overflow">
          <div class="col border col-8 p-3" style="width:99%;">
            <div class="text-center">
              ...
              <p class="text-center page_heading mb-2">QC Task List Under project</p>
            </div>
