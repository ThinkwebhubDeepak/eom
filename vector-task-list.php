...
$tasks = $vectorSQL->fetchAll(PDO::FETCH_ASSOC);
                ...
                <div class="row overflow">
                    <div class="col border col-8 p-3" style="width:99%;">
                        <div class="text-center">
                            ...
                            <p class="text-center page_heading mb-2">Vector Task List Under project</p>
                        </div>
                                            ...
                                            <tbody class="scroll-bar">
                                                ...
                                                ?>
                                                    <tr style="<?php echo $taskss['is_reassigned'] ? 'background: #e16767;' : ''; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            <td><span class="close <?php echo $taskss['vector_status'] ?>">
                                                                    <?php echo str_replace('_', ' ', $taskss['vector_status']) ?>
                                                            </td>
                                                        <?php } ?>
                                                        <td>
