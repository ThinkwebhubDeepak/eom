                        ...
                        <div class="row form-row mb-3">
                            <div class="col-12 col-sm-6 p-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="project_id" name="project_id" value="<?php echo $feedback['project_id'] ?>" required>
                                    <input type="hidden" id="project_id" name="task_id" value="<?php echo $feedback['type'] ?>" required>
                                </div>
                            </div>
