        ...
        <div class="card-header">
            ...
            <div class="card-body d-flex justify-content-sm-between">
                ...
                <div class="box">
                    ...
                    <p>Total Taken: <span class="vector_eff"><?php echo  convertMinutesToHoursAndMinutes($utt = ($pro['total_taken_time'] + $qc['total_taken_time'] + $qa['total_taken_time'] + $vector['total_taken_time'])) ?></span> .</p>
            ...
            foreach($tasks as $task){
              ...
              if($task['status'] != 'pending'){
                ...
                foreach($efficiny as $value){
                  $data .= '<li>'.$value['profile'].' '.$value['efficiency'].'% ('.$value['total_time'].' M / '.$value['taken_time'].' M)</li>';
                }
              }
