          ...
          <thead>
            <tr>
              ...
              <?php
                ...
                $assignCheck = $conn->prepare("SELECT DISTINCT assigned_by FROM `assign`");


                if($roleId == 4 || $roleId == 5 || $roleId == 1){
          ...
          <tbody>
            ...
            $i = 1;
              foreach($leaves as $leave){
                ...
                if($leave['enddate_session'] == 'Second Half' && $leave['formdate_session'] == 'First Half'){
                  $daysDifference += 1;
                }
                ...
                if($leave['formdate_session'] ==  $leave['enddate_session']){
                  ...
                  echo '
                    <tr id="row_'.$leave['id'].'">
                      ...
                      if($roleId == 4 || $roleId == 5 || $roleId == 1){
                        echo '<td> <a class="btn btn-primary" style="margin:0 10px" onclick="approveLeave('.$leave['id'].')">Approve</a><a class="btn btn-danger" onclick="cancelLeave('.$leave['id'].')">Cancel</a></td>';
                      }
