            ...
            ?>
              <div class=" border  w-100 p-2">
                <h2 class="accordion-header" id="flush-headingThree">
                  ...
                  <a href="project-details.php?project_id=<?php echo base64_encode($project['id']) ?>" style="text-decoration : none" class="projectID"> (<?php echo $project['project_name'] ?>)</a>
                        ...
                        <tbody class="scroll-bar">
                          ...
                          ?>
                            <tr>
                              ...
                              <td style="display: flex;justify-content: space-between;"><a href="task-details.php?task_id=<?php echo $t_id ?>&project_id=<?php echo $p_id ?>"><i style="color: black;" class="fas fa-info-circle"></i></a>
                            <?php
                              if ($roleId == 1 || in_array('create-task', $pageAccessList)) {
                            ?>
                                <a href="create-task.php?edit=<?php echo $t_id ?>"><i style="color: #0001fa;" class="fas fa-edit"></i></a><a onclick="deleteTask('<?php echo $task['task_id'] ?>','<?php echo $task['project_id'] ?>')"><i style="color: #dd0000;" class="fas fa-trash"></i></a>
                            <?php
                              }
                            ?>
                            </td>
